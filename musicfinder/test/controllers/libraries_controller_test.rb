...
class LibrariesControllerTest < ActionController::TestCase
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post :create, library: { album: @library.album, artist: @library.artist, song: @library.song, year: @library.year }
    end
  ...
  test "should update library" do
    patch :update, id: @library, library: { album: @library.album, artist: @library.artist, song: @library.song, year: @library.year }
    assert_redirected_to library_path(assigns(:library))
  end
